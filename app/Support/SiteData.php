...
class SiteData
{
    ...
    /** Blog listing — src/app/pages/BlogsPage.tsx allBlogPosts. */
    ...
    /** Category filter pills — BlogsPage.tsx categories. */
    ...
    {
        // BlogsPage GallerySection + EventGalleryPage (images match reference).
        return [
            [
